        ...
        >
          <div className="relative group">
            ...
            <div className="client-glass-card relative overflow-hidden rounded-3xl p-6" style={{ ['--card-glow' as string]: 'rgba(255,255,255,0.18)' }}>
              ...
              {/* Links de esqueci senha e criar conta */}
              <div className="mt-4 space-y-2 text-center">
                ...
                {showSignUpLink && onSignUpClick && (
                  <div>
                    <span className="text-white/60 text-xs">Não tem conta? </span>
                    <button
                      onClick={onSignUpClick}
                      className="text-white hover:text-cyan-300 text-xs transition-colors duration-300 underline"
                    >
                      Criar conta
                    </button>
                  </div>
