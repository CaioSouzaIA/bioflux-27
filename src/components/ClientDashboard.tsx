...
const SubscriptionCard: React.FC<{ subscription: Subscription; userProfile: any }> = ({ subscription, userProfile }) => {
...
const FeatureCard: React.FC<{
  ...
  <Card className={`bg-[#161616] border-black backdrop-blur-sm transition-all flex flex-col ${
    disabled ? 'opacity-60 cursor-not-allowed' : 'hover:bg-[#1c1c1c] cursor-pointer'
  }`}>
    <CardHeader>
      ...
      {count !== undefined && (
        <div className="flex items-center justify-center mb-4">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm">{countLabel}</p>
              ...
              <CardContent>
                {subscriptions.length === 0 ? (
                  ...
                  <div className="grid gap-4">
                    {subscriptionsI see there's still a syntax error. Let me fix the ClientDashboard component completely:

<dyad-write path="src/components/ClientDashboard.tsx" description="Fixed syntax error and refactored ClientDashboard to be more modular">
import React, { useState, useEffect } from 'react';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
