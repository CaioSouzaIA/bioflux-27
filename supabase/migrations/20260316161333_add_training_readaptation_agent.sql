ALTER TABLE public.ai_agent_prompt_versions
  DROP CONSTRAINT IF EXISTS ai_agent_prompt_versions_agent_key_check;

ALTER TABLE public.ai_agent_prompt_versions
  ADD CONSTRAINT ai_agent_prompt_versions_agent_key_check
  CHECK (
    agent_key IN (
      'diet_generation',
      'training_generation',
